                ...
                <table class="nav-justified" style="height: 559px">
                    ...
                    <tr>
                        <td class="text-center" style="width: 373px; color: #000000;"><span style="font-size: small"><span style="color: #000000"><strong>Password:</strong><br />
                            ...
                            <asp:TextBox ID="txtPassword" runat="server" Height="24px" style="font-size: x-small" Width="236px" Placeholder="at least 6 characters,include number and capital"></asp:TextBox>
                            <br />
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtPassword" ErrorMessage="6 characters or more,include Capital"  ValidationExpression="(?=.*[A-Z])[A-Za-z\d]{6,}" style="color: #FF0000; font-size: xx-small"></asp:RegularExpressionValidator>
                        </td>
                        <td class="text-center" style="width: 354px"><span style="font-size: small"><span style="color: #000000"><strong>Retype Password:</strong><br />
                            ...
                            <br />
                            <asp:CompareValidator ID="CompareValidator1" runat="server" ErrorMessage="Password not same" ControlToCompare="txtPassword" ControlToValidate="txtRetype" EnableClientScript="False" style="color: #FF0000; font-size: xx-small"></asp:CompareValidator>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="text-center" style="width: 721px; height: 70px;"><span style="font-size: small"><span style="color: #000000"><strong>Level:</strong><br />
                            <br />
                            <asp:DropDownList ID="ddlLvl" runat="server" Height="22px" style="font-size: x-small; margin-left: 30;" Width="241px">

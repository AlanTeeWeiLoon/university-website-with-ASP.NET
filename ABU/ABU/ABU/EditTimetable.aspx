<%@ Page Title="" Language="C#" MasterPageFile="~/Index.Master" AutoEventWireup="true" CodeBehind="EditTimetable.aspx.cs" Inherits="ABU.EditTimetable" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <strong>    <asp:Label ID="Label1" runat="server" Text="Edit Time Table" ForeColor="Black" style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-size: x-large"></asp:Label>
    </strong>
        ...
        <table class="nav-justified" style="height: 430px; width: 92%; margin-left: 30px;">
            ...
            <tr>
                <td class="text-center" colspan="2">
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Button ID="btnDelete" runat="server" BackColor="#0066CC" Height="28px" OnClick="btnUpdate_Click" style="color: #FFFFFF; font-size: x-small; font-family: 'Bahnschrift SemiLight'" Text="Delete" Width="129px" />
                </td>
            </tr>
        </table>

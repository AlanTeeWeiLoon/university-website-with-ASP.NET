...
namespace ABU
{
    public partial class EditSlidePage : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                txtLink.Text = dt.Rows[0][5].ToString();
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            string query = "update Template set Title ='" + txtTitle.Text + "',Image ='" + "applicant/" + filename + "',Link ='" + txtLink.Text +
                "'where TemplateId = '" + id + "'";

            SqlCommand cmd = new SqlCommand(query, con);
            cmd.ExecuteNonQuery();
            con.Close();
            Response.Redirect("EditSlide.aspx");
        }
    }
}
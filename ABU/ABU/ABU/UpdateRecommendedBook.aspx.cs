...
namespace ABU
{
    public partial class UpdateRecommendedBook : System.Web.UI.Page
    {
        ...
        {
            con.Open();
            string query = "update Book set Recommend ='Recommended' where BookId = '" + id + "'";

            SqlCommand cmd = new SqlCommand(query, con);
            cmd.ExecuteNonQuery();
            lblMessage.ForeColor = System.Drawing.Color.ForestGreen;
            lblMessage.Text = "Book Recommended Successfully";
            con.Close();
        }
    }
}
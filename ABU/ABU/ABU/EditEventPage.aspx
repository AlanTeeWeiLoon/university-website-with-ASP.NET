<%@ Page Title="" Language="C#" MasterPageFile="~/Index.Master" AutoEventWireup="true" CodeBehind="EditEventPage.aspx.cs" Inherits="ABU.EditEventPage" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      <p style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-size: large; color: #000000">
        <strong>Edit Event Page</strong></p>
    <table class="nav-justified" style="background-color:white; height: 339px; width: 70%; margin-left: 153px;">
        ...
        <tr>
            <td style="height: 11px; width: 175px; font-size: small; color: #000000;" class="text-center">Date:</td>
            <td style="height: 50px; width: 163px">
                <asp:TextBox ID="txtDate" runat="server" placeholder="exp: July 12th" Height="36px" style="margin-bottom: 4" Width="174px"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="modal-sm" style="width: 175px; font-size: small; color: #000000; text-align: center;">Description:</td>
            <td style="width: 163px">
                <asp:TextBox ID="txtDescribe" runat="server" Height="36px" style="margin-bottom: 4" Width="174px" TextMode="MultiLine"></asp:TextBox>
            </td>
        </tr>
        <tr>
